 ...
 */
final class Version20240519145102 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE consumo_dia (id INT AUTO_INCREMENT NOT NULL, fecha DATE NOT NULL, comida VARCHAR(255) NOT NULL, cantidad DOUBLE PRECISION NOT NULL, momento VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE peso (id INT AUTO_INCREMENT NOT NULL, fecha DATE NOT NULL, peso DOUBLE PRECISION NOT NULL, imc DOUBLE PRECISION NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
