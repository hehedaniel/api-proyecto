 ...
 */
final class Version20240519161847 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE alimento (id INT AUTO_INCREMENT NOT NULL, usuario_proponedor_id INT NOT NULL, nombre VARCHAR(255) NOT NULL, descripcion LONGTEXT NOT NULL, marca VARCHAR(255) NOT NULL, cantidad DOUBLE PRECISION NOT NULL, proteinas DOUBLE PRECISION NOT NULL, grasas DOUBLE PRECISION NOT NULL, carbohidratos DOUBLE PRECISION NOT NULL, azucares DOUBLE PRECISION NOT NULL, vitaminas DOUBLE PRECISION NOT NULL, minerales DOUBLE PRECISION NOT NULL, imagen LONGTEXT NOT NULL, INDEX IDX_A3C39593F1239A8E (usuario_proponedor_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE ejercicio (id INT AUTO_INCREMENT NOT NULL, usuario_proponedor_id INT NOT NULL, nombre VARCHAR(255) NOT NULL, descripcion LONGTEXT NOT NULL, grupo_muscular VARCHAR(255) NOT NULL, dificultad VARCHAR(255) NOT NULL, instrucciones LONGTEXT NOT NULL, calorias_quemadas DOUBLE PRECISION NOT NULL, INDEX IDX_95ADCFF4F1239A8E (usuario_proponedor_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE receta (id INT AUTO_INCREMENT NOT NULL, usuario_creador_id INT NOT NULL, nombre VARCHAR(255) NOT NULL, descripcion LONGTEXT NOT NULL, instrucciones LONGTEXT NOT NULL, cantidad_final DOUBLE PRECISION NOT NULL, proteinas DOUBLE PRECISION NOT NULL, grasas DOUBLE PRECISION NOT NULL, carbohidratos DOUBLE PRECISION NOT NULL, azucares DOUBLE PRECISION NOT NULL, vitaminas DOUBLE PRECISION NOT NULL, minerales DOUBLE PRECISION NOT NULL, imagen LONGTEXT NOT NULL, INDEX IDX_B093494E91C4469F (usuario_creador_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE usuario_ejercicio (usuario_id INT NOT NULL, ejercicio_id INT NOT NULL, INDEX IDX_1C9625E6DB38439E (usuario_id), INDEX IDX_1C9625E630890A7D (ejercicio_id), PRIMARY KEY(usuario_id, ejercicio_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE messenger_messages (id BIGINT AUTO_INCREMENT NOT NULL, body LONGTEXT NOT NULL, headers LONGTEXT NOT NULL, queue_name VARCHAR(190) NOT NULL, created_at DATETIME NOT NULL, available_at DATETIME NOT NULL, delivered_at DATETIME DEFAULT NULL, INDEX IDX_75EA56E0FB7336F0 (queue_name), INDEX IDX_75EA56E0E3BD61CE (available_at), INDEX IDX_75EA56E016BA31DB (delivered_at), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE alimento ADD CONSTRAINT FK_A3C39593F1239A8E FOREIGN KEY (usuario_proponedor_id) REFERENCES usuario (id)');
        $this->addSql('ALTER TABLE consumo_dia ADD CONSTRAINT FK_77412CD17EB2C349 FOREIGN KEY (id_usuario_id) REFERENCES usuario (id)');
        $this->addSql('ALTER TABLE ejercicio ADD CONSTRAINT FK_95ADCFF4F1239A8E FOREIGN KEY (usuario_proponedor_id) REFERENCES usuario (id)');
        ...
        $this->addSql('ALTER TABLE receta ADD CONSTRAINT FK_B093494E91C4469F FOREIGN KEY (usuario_creador_id) REFERENCES usuario (id)');
        ...
        $this->addSql('ALTER TABLE usuario_ejercicio ADD CONSTRAINT FK_1C9625E6DB38439E FOREIGN KEY (usuario_id) REFERENCES usuario (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE usuario_ejercicio ADD CONSTRAINT FK_1C9625E630890A7D FOREIGN KEY (ejercicio_id) REFERENCES ejercicio (id) ON DELETE CASCADE');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE alimento DROP FOREIGN KEY FK_A3C39593F1239A8E');
        $this->addSql('ALTER TABLE consumo_dia DROP FOREIGN KEY FK_77412CD17EB2C349');
        $this->addSql('ALTER TABLE ejercicio DROP FOREIGN KEY FK_95ADCFF4F1239A8E');
        ...
        $this->addSql('ALTER TABLE receta DROP FOREIGN KEY FK_B093494E91C4469F');
        ...
        $this->addSql('ALTER TABLE usuario_ejercicio DROP FOREIGN KEY FK_1C9625E6DB38439E');
        $this->addSql('ALTER TABLE usuario_ejercicio DROP FOREIGN KEY FK_1C9625E630890A7D');
        ...
        $this->addSql('DROP TABLE usuario_ejercicio');
